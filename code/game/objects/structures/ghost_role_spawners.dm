...
/obj/effect/mob_spawn/human/hermit/Initialize(mapload)
	...
	switch(arrpee)
		...
		if(3)
			flavour_text += "you were a doctor on one of N-Corporation's space stations, but you left behind that damn corporation's tyranny and everything it stood for. From a metaphorical hell \
		...
		if(4)
			...
			at one of N-Corporation's state-of-the-art research facilities, were in one of the escape pods alone and saw the red button. It was big and shiny, and it caught your eye. You pressed \
...
/obj/effect/mob_spawn/human/syndicate/battlecruiser/special(mob/living/new_spawn)
...
/datum/outfit/syndicate_empty/sbc/med
	name = "Syndicate Battlecruiser Ship Medical Doctor"
	uniform = /obj/item/clothing/under/mercenary/medic
...
/obj/effect/mob_spawn/human/pirate
	...
	flavour_text = "The neighborhood refused to pay for your protection, protect the ship, siphon the ahn from the facility and raid it for even more loot."
