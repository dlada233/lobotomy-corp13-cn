...
/obj/item/paper/fluff/info/aleph/tso
	...
	abno_info = list(
		...
		"各乐章弱点变化：第一乐章弱蓝色，第二乐章弱黑色，第三乐章弱白色，第四乐章仅红色攻击有效。终章高潮时获得全伤害免疫。")
...
/obj/item/paper/fluff/info/aleph/rose
	...
	abno_info = list(
		...
		"“选中者”对其的持续工作，F-04-116 会逐渐被“染红”，直至异想体准备好“绽放”。在异想体被染红的过程中，员工在工作时会逐渐受到不可避免的递增的蓝色伤害。",
		"当 F-04-116 完全被“染红”，或者在有“选中者”员工存活的情况下逆卡巴拉计数器归零时，会触发一次“绽放”事件。",
		"在“绽放”事件期间，被选中的员工会受到大量的、不可避免的蓝色伤害。如果 F-04-116 尚未完全“染红”，则该伤害是致命的，并且会使员工感染疾病。",
...
/obj/item/paper/fluff/info/aleph/titania
	...
	"突破收容时，提泰妮娅会设立规则，如果员工违反规则，则会受到蓝色伤害。",
	"当一名员工在恐慌或重伤状态下被提泰妮娅攻击时，他们会被直接抹杀。")
	abno_breach_damage_type = "红色/蓝色"
...
/obj/item/paper/fluff/info/aleph/seasons
	...
	abno_work_damage_type = "白色/红色/黑色/蓝色"
	abno_breach_damage_type = "白色/红色/黑色/蓝色"
	abno_resistances = list(
