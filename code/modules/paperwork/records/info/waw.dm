...
/obj/item/paper/fluff/info/waw/qoh
	...
	abno_info = list(
		...
		"当逆卡巴拉计数器处于最大值时，若设施内有4名员工死亡，憎恶皇后会自愿协助异常镇压。然而，如果在提供协助期间有50%的员工死亡，异常的状态将会改变并需要立即镇压。",
		"当憎恶皇后的逆卡巴拉计数器变为1时，其状态发生改变。在此状态下工作成功率较低。由于她的焦虑和强迫症，该状态被指定为“歇斯底里”。",
...
/obj/item/paper/fluff/info/waw/silence
	...
	abno_info = list(
		...
		"若在两次钟声鸣响之间未满足上述任一条件，所有员工将受到巨额蓝色伤害。")
...
/obj/item/paper/fluff/info/waw/greedking
	...
	abno_info = list(
		...
		"当工作结果为差时，逆卡巴拉计数器有高概率减少。",
		"贪婪国王的行为模式是在逃脱时吞噬路径上的一切物体。镇压时请注意异常移动方向。")
	abno_breach_damage_type = "红色"
	abno_breach_damage_count = "极高"
