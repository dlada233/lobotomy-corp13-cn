...
/obj/item/gun/mindwhip/process_fire(atom/target, mob/living/user, message = TRUE, params = null, zone_override = "", bonus_spread = 0)
	var/list/banned_roles = list("R-Corp Scout Raven - R-公司侦查渡鸦", "R-Corp Support Raven - R-公司支援渡鸦", "Rhino Squad Captain-乌鸦队队长", "R-Corp Suppressive Rabbit - R-公司抑制兔子", "R-Corp Assault Rabbit - R-公司突击兔子", "R-Corp Suppressive Rabbit - R-公司抑制兔子", "R-Corp Medical Reindeer - R-公司医疗驯鹿")
...
/obj/item/gun/mindwhip/proc/on_beam_tick(mob/living/target)
	target.deal_damage(beam_damage, damtype, attack_type = (ATTACK_TYPE_RANGED | ATTACK_TYPE_SPECIAL))
