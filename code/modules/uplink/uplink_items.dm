...
/datum/uplink_item/role_restricted/brainwash_disk
	...
	restricted_roles = list("Medical Doctor", "Chief Medical Officer", "Roboticist", "Cybersun Infiltrator", "MI13 Infiltrator") // Tegustation Infiltration
	cost = 5
...
/datum/uplink_item/role_restricted/laser_arm
	...
	restricted_roles = list("Roboticist", "Research Director", "Cybersun Infiltrator", "MI13 Infiltrator") // Tegustation Infiltration
...
/datum/uplink_item/role_restricted/sleepyemais
	...
	cost = 6
	restricted_roles = list("Clerk", "Operations Officer-作战军官", "Support Officer-支援军官") //Same roles that can use it.
...
/datum/uplink_item/badass/syndiecash
	...
	desc = "A secure briefcase containing 5000 ahn. Useful for bribing personnel, or purchasing goods \
